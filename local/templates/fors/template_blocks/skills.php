      ...
      <section class="page-section__flex skills " aria-labelledby="skills-title">
        ...
        <div class="driving-layout">
          <aside class="driving-sidebar" aria-labelledby="skills-sidebar-title">
            <p class="driving-sidebar__title" id="skills-sidebar-title">Курсантам:</p>
          ...
          <div class="driving-content">
            <div class="driving-content__intro">
              <p class="driving-content__intro-text">
                ...
                опасности на дорогах. В противном случае высока вероятность совершения элементарных ошибок, следствием
                которых может стать ДТП. Оптимальный вариант — прохождение специальной ускоренной программы. Автошкола
                «Форсаж» в Воронеже предлагает курс восстановления утраченных навыков вождения автомобиля с инструктором,
                благодаря которому можно быстро выйти на привычный уровень.
              </p>
            </div>
            ...
            <div class="driving-section" role="region" aria-labelledby="skills-features-title">
              ...
              <p class="driving-content__text">
                ...
                к знакомым автовладельцам. Однако подобные пробные поездки менее эффективны, чем работа с опытным
                автоинструктором. Профессионал предоставит объективную характеристику текущей готовности, поможет
                выявить типичные ошибки, допускаемые в процессе управления, и даст полезные советы по их устранению.
              </p>
              <p class="driving-content__text">
                Разумеется, проходить с самого начала весь курс обучения на права не нужно. Для восстановления
                водительских навыков после длительного перерыва достаточно нескольких уроков, за время которых можно
                вспомнить основные нюансы вождения, почувствовать габариты ТС и отработать базовые приёмы. Количество
            ...
            <div class="driving-section" role="region" aria-labelledby="skills-useful-title">
              ...
              <p class="driving-content__text">
                ...
                При необходимости можно организовать уроки как на специальном автодроме, так и в городских условиях,
            ...
            <div class="driving-section" role="region" aria-labelledby="skills-benefits-title">
              <h3 id="skills-benefits-title">МКПП и АКПП</h3>

              <p class="driving-content__text">
                В автопарке школы «Форсаж» представлены модели на механике и автомате, что позволяет найти подходящий
                вариант для каждого обучающегося. Стандартная программа предусматривает следующие блоки:
              </p>
      ...
      <section class="page-section page-section__flex skills container" aria-labelledby="skills-restoration-title">
        ...
        <div class="skills__container">
          <p class="skills__description">
            Расценки напрямую зависят от количества занятий, которые необходимо пройти, а также от особенностей
            выбранной программы. Стоимость каждого урока фиксирована, что исключает доплаты и делает процесс обучения
            максимально прозрачным и понятным для каждого клиента. Учитывая индивидуальные особенности водителя,
            количество часов может варьироваться: кому-то достаточно нескольких занятий для уверенного возвращения
            за руль, а кто-то предпочтет более детально наверстать упущенное.
          </p>
          <p class="skills__description">
            Для получения дополнительной информации позвоните по телефону +7 (473) 269-00-00 либо оставьте заявку
            на сайте через форму обратной связи. Специалисты автошколы «Форсаж» подробно проконсультируют и помогут
            вам выбрать подходящий курс восстановления навыков вождения.
          </p>
        </div>
      </section>
<?$APPLICATION->IncludeComponent(
