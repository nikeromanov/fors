<?php
// Плитки с ключевыми преимуществами обучения
?>
<!-- bx:about-highlights -->
<section class="page-section about-highlights" aria-labelledby="about-highlights-title">
  <h2 class="page-section__title" id="about-highlights-title">Этапы получения водительского удостоверения</h2>
  <ul class="about-highlights__grid">
    ...
    <li class="about-highlights__card about-highlights__card--car" aria-hidden="true">
      <picture>
        <source type="image/webp" srcset="assets/img/about/car.webp" />
        <img
          src="assets/img/about/car.png"
          alt="машина"
    ...
    <li class="about-highlights__card">
      <h3 class="about-highlights__card-title about-highlights__card-title--accent">02.</h3>
      <p class="about-highlights__card-text">
        Приходи
        <br />
        на пробное
    ...
    <li class="about-highlights__card about-highlights__card--girl" aria-hidden="true">
      <picture>
        <source type="image/webp" srcset="assets/img/about/girl.webp" />
        <img
          src="assets/img/about/girl.png"
          alt="Девушка"
          class="about-highlights__card-image"
          width="315"
          height="315"
