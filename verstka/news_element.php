...
<html lang="ru">
  ...
  <body>
    ...
    $breadcrumbItems = [
      ["title" =>
      "Главная", "url" => "/"], ["title" => "Новости", "url" => "news.php"], ["title" => "Дополнительная скидка 13%"],
        ...
        <div class="news-detail__inner u-container">
          ...
          <article class="news-detail__article">
            <header class="news-detail__header">
              <h1 class="news-detail__title" id="news-detail-heading">Дополнительная скидка 13% — как? Читайте!</h1>
